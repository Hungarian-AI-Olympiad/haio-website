...
<section class="min-h-screen bg-desert-100 relative overflow-hidden pt-24 pb-12">
	...
	<div class="container mx-auto px-6 relative z-10">
		<!-- Back Button -->
		<div class="mb-6">
			<a href="{base}/2024#results-summary" on:click|preventDefault={() => goBack(`${base}/2024#results-summary`)} class="inline-flex items-center gap-2 text-warm-blue hover:text-dark-blue transition-colors font-semibold">
		...
		<div class="mt-12 text-center">
			<a
				href="{base}/2024#results-summary"
				on:click|preventDefault={() => goBack(`${base}/2024#results-summary`)}
